...
inequality_aversion2=clogit(A ~ payoff + other_payoff_ahead + other_payoff_behind  + strata(subject_id), 
                           data=df_master)
...
tab_model(social_expectation, inequality_aversion, social_expectation_aug1, dv.labels = c("Social Exp", "Ineq. Avers.", "Soc. Exp. Aug."), show.aic = T, show.loglik = T, show.se = T, show.ci = F, title = treatment, transform=NULL)
