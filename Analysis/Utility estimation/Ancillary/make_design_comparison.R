...
lines <- c(
  ...
  "\\midrule",
  row2("Full (Eq. 6)", "Within", nu_w$k, gamma = cell(nu_w$gammaNU, nu_w$se_gammaNU), eta = cell(nu_w$etaNU, nu_w$se_etaNU), nu = cell(nu_w$nuNU, nu_w$se_nuNU), aic = fmt_aic(nu_w$NU_AIC)),
  "\\midrule",
  row2("Full (Eq. 6)", "Between", nu_b$k, gamma = cell(nu_b$gammaNU, nu_b$se_gammaNU), eta = cell(nu_b$etaNU, nu_b$se_etaNU), nu = cell(nu_b$nuNU, nu_b$se_nuNU), aic = fmt_aic(nu_b$NU_AIC)),
  "\\bottomrule",
  "\\end{tabular}}",
