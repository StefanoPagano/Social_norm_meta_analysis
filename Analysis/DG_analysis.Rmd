...
utility_df_treatment_demo <- utility_df_treatment %>%
  filter(!(paper_id %in% c("2018Her061", "2007Lis165", "2012Laz164")))
...
<!--   model_sp=mclogit::mclogit(cbind(A,id)~ other_payoff_behind, data=utility_df_treatment_sp%>%  -->
<!--                            filter(treatment_id==i)) -->
...
## Social Preferences mlogit model (Fehr & Schimdt 1999)
...
list_model = list(ml.paper1, ml.paper2, ml.paper3, ml.paper4, ml.paper5, ml.paper6)
```


```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment="", fig.align="center", fig.width = 14, fig.height=14}
tab_model(list_model, dv.labels = c("2016Kim003_7", "2018Her061_9", "2019Cha026_1", "2020Bas115_2a", "2007Lis165_1a", "2012Laz164_3"), show.aic = T, show.loglik = T, show.se = T, show.ci = F, title = "Model Estimates", transform=NULL)
```