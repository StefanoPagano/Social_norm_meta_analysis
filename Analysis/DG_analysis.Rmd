...
## Social Expectation Model {.tabset}

$U_{ik} = \alpha \pi_k + \beta A_k + \epsilon_{ik}$

* $\pi_k$ indicate the payoff
* $A_k$ indicate the norm appropriateness 
...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
tab_model(model_se_list, dv.labels = levels(as.factor(utility_df_treatment$treatment_id)), show.aic = T, show.loglik = T, show.se = T, show.ci = F, title = "Model Estimates")
...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
tab_model(model_list_gender, dv.labels = levels(as.factor(utility_df_treatment_demo$treatment_id)), show.aic = T, show.loglik = T, show.se = T, show.ci = F, title = "Model Estimates")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
tab_model(model_list_age, dv.labels = levels(as.factor(utility_df_treatment_demo$treatment_id)), show.aic = T, show.loglik = T, show.se = T, show.ci = F, title = "Model Estimates")
```
