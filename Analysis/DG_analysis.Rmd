...
list_model = list(ml.paper1, ml.paper2, ml.paper3, ml.paper4)
```


```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
tab_model(list_model, dv.labels = c("2016Kim003_7", "2018Her061_9", "2019Cha026_1", "2020Bas115_2a"), show.aic = T, show.loglik = T, show.se = T, show.ci = F, title = "Model Estimates", transform=NULL)
```