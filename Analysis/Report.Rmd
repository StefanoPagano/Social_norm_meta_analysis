...
# Individual-level analysis (Utility framework)
...
summary(clogit.bas)
dataframe_betas[i,] <- c("2020Bas115",clogit.bas$coefficients["payoff"],clogit.bas$coefficients["KW_Normative"],clogit.bas$var[1,1],clogit.bas$var[2,2])
```
...
summary(clogit.kim)
dataframe_betas[i,] <- c("2016Kim003",clogit.kim$coefficients["payoff"],clogit.kim$coefficients["KW_Normative"],clogit.kim$var[1,1],clogit.kim$var[2,2])
```
...
summary(mlogit.her)
summary(clogit.her)
dataframe_betas[i,] <- c("2018Her061",clogit.her$coefficients["payoff"],clogit.her$coefficients["KW_Normative"],clogit.her$var[1,1],clogit.her$var[2,2])
...
summary(mlogit.cha)
dataframe_betas[i,] <- c("2019Cha026",clogit.cha$coefficients["payoff"],clogit.cha$coefficients["KW_Normative"],clogit.cha$var[1,1],clogit.cha$var[2,2])
```
...
## Individual analysis of norm compliance
