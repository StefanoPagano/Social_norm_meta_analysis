...
### 2017Del037
```{r}
Del037 = individual_db_w %>% subset.data.frame(paper_id=="2017Del037")
mlogit.del <- mlogit.data(Del037, choice = "A", shape = "long", alt.var = "scenarios", id.var = "subjects_id", )
summary(mlogit(A~KW_Normative, data = mlogit.del))
```
...
>>>>>>> 68e32ffa99f2074467217539b1acf5d6cae92ed0
