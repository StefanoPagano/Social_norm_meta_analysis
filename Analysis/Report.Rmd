...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
cor.test(master$specificity_old, master$Delta, method= "spearman", exact = F)
...
<h2>Overview of the computed statistics</h2>
...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
cor.test(master$Avg_KW_m, master$Delta, method= "spearman", exact = F)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
cor.test(master$Avg_KW_m, master$specificity_plus, method= "spearman", exact = F)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
cor.test(master$Avg_KW_m, master$consistency, method= "spearman", exact = F)
