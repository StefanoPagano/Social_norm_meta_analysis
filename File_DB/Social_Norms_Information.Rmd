...
$$\sigma\left(max\left(\frac{\sum_{j=1}^{J}\theta_j}{N}\right),\ \theta_j=\sum_{i=1}^{N}\alpha_{i,j},\ j\in\{1:N\}\right)$$
...
With this criteria, the number of treatments in targer is 213.
In the following, 
